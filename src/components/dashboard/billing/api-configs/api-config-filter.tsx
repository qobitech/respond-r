...
import { getAPIConfigs } from 'store/actions';
...
const APIConfigFilter = (props: IProps) => {
    const { admin, users, isSearch, pageNumber, setPageNumber, rowsPerPage, setRowsPerPage, searchMode, setSearchMode, page, setPage, cancelQuery, isSearchEmpty, isMoreOption, setIsMoreOption, showOnlyPagination, filterCTAContent, getAPIConfigs } = props;
    ...
    return(
        <div style={{}}>
            <Filter isSearch={isSearch} isSearchEmpty={isSearchEmpty} searchMode={searchMode}
                ...
                totalCount={totalCount} getAll={getAPIConfigs}
                getBySearch={getAPIConfigs} clearBySearch={() => void(0)} pageName={pageName.API_CONFIGS}
